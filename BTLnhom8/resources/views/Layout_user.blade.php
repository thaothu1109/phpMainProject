    ...
    <div id="page">
                                             ...
                                             <div class="wrap-popup">
                                                 <div class="popup">
                                                     <div class="row">
                                                         <div class="col-sm-6">
                                                             <ul class="nav">
                                                                 <li><a href="grid.html"><span>Lưới</span></a></li>
                                                                 <li>
                                                                     <a href="list.html"> <span>Danh sách</span></a>
                                                                 </li>
                                                                 <li>
                                                                     <a href="product_detail.html"> <span>Sản phẩm
                                                                             Chi tiết</span></a>
                                                                 </li>
                                                                 <li>
                                                                     <a href="shopping_cart.html"> <span>Mua sắm
                                                                             Giỏ hàng</span></a>
                                                                 </li>
                                                                 <li><a href="checkout.html"><span>Thanh toán</span></a>
                                                                 </li>
                                                                 <li>
                                                         ...
                                                         <div class="col-sm-6 has-sep">
                                                             <ul class="nav">
                                                                 ...
                                                                 <li><a href="compare.html"><span>So sánh</span></a></li>
                                                                 <li><a href="quick_view.html"><span>Nhanh
                                                                             Xem</span></a></li>
                                                                 <li><a
                                                                         href="newsletter.html"><span>Bản tin</span></a>
                                                                 </li>
                        ...
                        <div class="features-block">
                            <div class="col-lg-7 col-md-9 col-xs-12 col-sm-8 offer-block">
                                <div class="feature-box first">
                                    <div class="content">
                                    <h3>Giao hàng miễn phí trên toàn quốc </h3>
                                     </div>
                                 </div>
        ...
        <footer class="footer">
                        ...
                        <div class="col-md-3 col-sm-6">
                         ...
                         <div class="col-md-3 col-sm-6">
                             ...
                             <div class="contacts-info">
                                 <địa chỉ>
                                     <i class="add-icon">&nbsp;</i>12 Chua Boc Street, Dong Da, <br>
                                     &nbsp;Ha Noi
                                 </địa chỉ>
                                 <div class="phone-footer"><i class="phone-icon">&nbsp;</i> +(012) 365-6531
                                 </div>
                                 <div class="email-footer"><i class="email-icon">&nbsp;</i> <a
                                         href="mailto:abc@magikcommerce.com">thecafeland@gmail.com</a> </div>
                             </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="footer-bottom">
                <div class="container">
                    <div class="row">
                    <div class="col-sm-5 col-xs-12 coppyright"> &copy; {{ now()->format('Y') }} The Cafe Land.
